...
$judul = '';
$artis = '';
$peringkat_minggu_ini = 1;
$peringkat_minggu_lalu = 1;
$foto = '';
...
if (isset($_POST['submit'])) {
    ...
    $slug = slug_maker($artis . '-' . $judul, 'td_chart');

    if ($_FILES['foto']['name']) {
        $foto = uploadFile($_FILES['foto'], '../../../app/data/img/foto-chart/');
    }

    mysqli_query($conn, "INSERT INTO td_chart VALUES ('', '$judul', '$slug', '$artis', $peringkat_minggu_ini, $peringkat_minggu_lalu, '$foto')");
    ...
    <main class="pt-5">
        ...
        <section class="container mb-5 py-5">
            <div class="row mt-5 mb-4">
                <div class="col my-5">
                    <div class="d-flex">
                        <h1 class="mx-auto border-dark border-bottom border-4 bigger-heading text-shadow-sm">Add To Chart</h1>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body p-lg-5 m-4">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="artis" name="artis" placeholder="Enter text" required>
                                    </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-8">
                                            <div class="mb-4">
                                                ...
                                                <input type="number" class="form-control form-control-lg" id="peringkat-minggu-ini" name="peringkat-minggu-ini" value="1" min="1" required>
                                            </div>
                                            <div class="mb-4">
                                                ...
                                                <input type="number" class="form-control form-control-lg" id="peringkat-minggu-lalu" name="peringkat-minggu-lalu" value="1" min="1" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 mt-5">
                                            ...
                                            <input class="d-none" type="file" name="foto" id="foto" accept="image/*" onchange="loadFile(event)" required>
                                        </div>
