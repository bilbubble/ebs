...
$result_news = query("SELECT * FROM td_news WHERE rubrik <> 'EBS Music BOX' ORDER BY id DESC LIMIT 5");
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-12 order-lg-last">
                                                    <img src="<?= $BASE_URL ?>app/data/img/foto-berita/<?= $result_news[$i]['foto'] ?>" alt="" class="w-100 rounded-5 object-fit-cover" style="height: 20vh;">
                                                </div>
                                                <div class="col-12">
                                                    <a href="<?= $BASE_URL ?>news/views?id=<?= $result_news[$i]['slug'] ?>" class="stretched-link">
                                                        <h5 class="article-content fw-semibold truncate-2-line"><?= $result_news[$i]['judul'] ?></h5>
                                                    </a>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row align-items-center">
                                            <div class="col-12 mb-4">
                                                <a href="<?= $BASE_URL ?>news/views?id=<?= $result_news[4]['slug'] ?>" class="stretched-link">
                                                    <h2 class="article-content mb-4 px-lg-3 fw-semibold truncate-3-line"><?= $result_news[4]['judul'] ?></h2>
                                                </a>
                                                <img src="<?= $BASE_URL ?>app/data/img/foto-berita/<?= $result_news[4]['foto'] ?>" alt="" class="w-100 rounded-5 object-fit-cover" style="height: 30vh;">
                                            </div>
                                            <div class="col-12">

                                                <p class="truncate-8-line"><?= $result_news[4]['konten'] ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
