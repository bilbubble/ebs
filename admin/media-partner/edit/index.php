...
if (isset($_POST['submit'])) {
    ...
    $judul = $_POST['nama-acara'];
    $tanggal = $_POST['tanggal-acara'];
                                    ...
                                    <div class="card-body p-lg-5">
                                        <div class="mb-5">
                                            <label for="nama-instansi" class="form-label">
                                                <p class="fs-4 text-muted mb-1">Nama Instansi</p>
                                            </label>
                                            <input type="text" class="form-control" id="nama-instansi" name="nama-instansi" placeholder="Enter text" value="<?= $result['nama'] ?>" required>
                                        </div>

                                        <div class="mb-5">
                                            <label for="nama-acara" class="form-label">
                                                <p class="fs-4 text-muted mb-1">Nama Acara</p>
                                            </label>
                                            <input type="text" class="form-control" id="nama-acara" name="nama-acara" placeholder="Enter text" value="<?= $result['judul'] ?>" required>
                                        </div>

                                        <div class="mb-5">
                                            <label for="tanggal-acara" class="form-label">
                                                <p class="fs-4 text-muted mb-1">Tanggal Acara</p>
                                            </label>
                                            <input type="date" class="form-control" id="tanggal-acara" name="tanggal-acara" placeholder="Enter text" value="<?= $result['tanggal'] ?>" required>
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <br>
                                            <a class="btn btn-outline-pink btn-lg px-5" href="<?= $BASE_URL ?>app/data/file/media-partner/<?= $result['file'] ?>" download="<?= $result['nama'] . ' - ' . $result['judul'] ?>"><i class="bi bi-file-earmark-fill"></i>&ensp;Download</a>
                                        </div>
